    ...
    <body>
        ...
        <section class="dashboard">
            <div class="box-container">
             ...
             <?php
             $total_pendings = 0; 
             $select_pendings = mysqli_query($conn, "SELECT * FROM `order` WHERE payment_status = 'pending'") or die(mysqli_error($conn));
             while ($fetch_pending = mysqli_fetch_assoc($select_pendings)){
                $total_pendings += $fetch_pending['total_price'];
             }  
             ?>
             <h3>npr <?php echo $total_pendings; ?></h3>
             <p> total pendings </p>
            </div>
            <div class="box">
             <?php
             ...
             ?>
             <h3>npr <?php echo $total_completes; ?></h3>
             <p> total completes </p>
            </div>
            <div class="box">
             <?php
